...
AI_MODEL_API_KEY = config('AI_MODEL_API_KEY')
...
SECRET_KEY = 'django-insecure-$*9or4y)o!1!zy5@vfz6z=eg$n&49bd1h$nza+*ukwudpzuc1y'
...
WSGI_APPLICATION = 'scrapapply.wsgi.application'
